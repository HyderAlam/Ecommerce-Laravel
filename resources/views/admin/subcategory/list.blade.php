            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route('subcategory.index') }}'" class="btn btn-danger" >Reset</button>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="deleteSubcategory( {{ $category->id }})" class="text-danger w-4 h-4 mr-1">
