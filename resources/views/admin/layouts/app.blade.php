...
<head>
    ...
    <!-- Dropzone -->
    <link rel="stylesheet" href="{{ asset('admin_files/plugins/dropzone/min/dropzone.min.css') }}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('admin_files/css/adminlte.min.css') }}">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('admin_files/css/custom.css') }}">
    <!-- Summernote -->
    <link rel="stylesheet" href="{{ asset('admin_files/plugins/summernote/summernote.min.css') }}">
...
<body class="hold-transition sidebar-mini">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
                        <img src="{{asset('admin_files/img/avatar5.png') }}" class='img-circle elevation-2' width="40" height="40" alt="">
                    </a>
    ...
    <script src="{{ asset('admin_files/plugins/dropzone/min/dropzone.min.js') }}"></script>
    <script src="{{ asset('admin_files/plugins/summernote/summernote.min.js') }}"></script>
    <script src="{{ asset('admin_files/plugins/select2/js/select2.min.js') }}"></script>
